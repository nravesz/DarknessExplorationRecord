...
function Description({ story }: { story: IGhostStory }) {
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <div>
        <div className="text-xs uppercase tracking-widest text-base-content/40 mb-3">Medium to Enter</div>
        <p className="text-base-content/70 leading-relaxed">{story.mediumToEnter}</p>
      </div>
